...
import Sidebar from '../qa-portal/components/Sidebar';
import Header from '../qa-portal/components/Header';
import DashboardView from '../qa-portal/components/DashboardView';
import CallUploadView from '../qa-portal/components/CallUploadView';
import AIInsightsView from '../qa-portal/components/AIInsightsView';
import DieticianReportsView from '../qa-portal/components/DieticianReportsView';
import QAAlertsView from '../qa-portal/components/QAAlertsView';
import TranscriptionsView from '../qa-portal/components/TranscriptionsView';

// Use the exact same component structure as Netlify QA Portal
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden font-sans bg-background text-on-background">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        ...
        {/* View Switchboard - Exact same as Netlify */}
